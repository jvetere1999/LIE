...
\lstset{
    basicstyle=\itshape
    xleftmargin=3em,
    literate={->}{$\rightarrow$}{α}{$\alpha$}{1}{δ}{$\delta$}{1}
}
%%%-------------------------------------------------------------------
%%%-------------------------------------------------------------------
%%%-------------------------------------------------------------------
...
\title{Lye: Grammar Definition and Regular Expressions}
...
\begin{abstract}
    Definition of Derivations used in the generation of acceptable code with in the LYE Standard. 
    The principles of this language are as follows. Static certain typing with a purly functional approch, 
    ability to represent functions in the form of a grammar function.
\end{abstract}
\begin{lstlisting}
S -> FA|LA|A
F -> fun
